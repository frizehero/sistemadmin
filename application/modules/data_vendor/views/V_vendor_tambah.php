<div class="app-main__inner">
                        ...
                        <div class="main-card mb-3 card">
                            ...
                            <form action="<?php echo base_url('data_vendor/tambah') ?>" method="POST" enctype="multipart/form-data">
                                <div class="card-body">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <input name="jenis_vendor"  type="text" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <input name="nama_usaha_vendor"  type="text" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <input name="nama_rekening_vendor"  type="text" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="col-md-12">
                                                <div class="position-relative form-group">
                                                    <label class="">Bank</label>
                                                     <textarea name="bank_vendor" class="form-control"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="position-relative form-group">
                                                    <label class="">Nomor Rekening</label>
                                                     <textarea name="norek_vendor" class="form-control"></textarea>
                                                </div>
                                            </div>
